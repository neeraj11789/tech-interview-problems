...
class ReverseLinkedListKGroupTest {

    private ReverseLinkedListKGroup reverseLinkedListKGroup;
    ...
    @Test
    void test1() {
        reverseLinkedListKGroup = new ReverseLinkedListKGroup( 3, head );
        ListNode run = this.reverseLinkedListKGroup.run();
        Assertions.assertThat( run.val == 3);
    }

    @Test
    void test2() {
        reverseLinkedListKGroup = new ReverseLinkedListKGroup( 2, head );
        ListNode run = reverseLinkedListKGroup.run();
        Assertions.assertThat( run.val == 2);
    }

    @Test
    void test3() {
        reverseLinkedListKGroup = new ReverseLinkedListKGroup( 2, null );
        ListNode run = reverseLinkedListKGroup.run();
        Assertions.assertThat( run == null);
    }
}